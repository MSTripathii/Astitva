...
export const AnimatedTestimonials = ({ testimonials, autoplay = false }) => {
  ...
  return (
    <div className="max-w-full mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 py-20 hell">
      {/* Heading */}
      ...
      <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="col-span-1 md:col-span-2 lg:col-span-2 md:flex justify-center items-center">
